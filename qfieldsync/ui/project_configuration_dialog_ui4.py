...
class Ui_QFieldProjectConfigurationBase(object):
    def setupUi(self, QFieldProjectConfigurationBase):
        ...
        self.multipleToggleButton = QtGui.QToolButton(self.groupBox)
        self.multipleToggleButton.setText(_fromUtf8(""))
        icon = QtGui.QIcon()
        ...
        self.multipleToggleButton.setPopupMode(QtGui.QToolButton.InstantPopup)
        self.multipleToggleButton.setAutoRaise(True)
        self.multipleToggleButton.setObjectName(_fromUtf8("multipleToggleButton"))
    ...
    def retranslateUi(self, QFieldProjectConfigurationBase):
        ...
        self.multipleToggleButton.setToolTip(_translate("QFieldProjectConfigurationBase", "Toggle layers", None))
